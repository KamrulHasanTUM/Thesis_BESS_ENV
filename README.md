...
| `continuous_line_loadings` | Line loading percentage | `(lines,)` | [0, 800] % |
| `continuous_load_data` | Load consumption | `(loads,)` | [0, 100K] MW |
| `continuous_sgen_data` | Generator output | `(gens,)` | [0, 100K] MW |
| `continuous_space_ext_grid_p_mw` | External grid active power | `(1,)` | ±50M MW |
| `continuous_space_ext_grid_q_mvar` | External grid reactive power | `(1,)` | ±50M MVAr |
...
**Built with care for advancing power grid intelligence**
