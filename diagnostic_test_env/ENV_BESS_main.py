...
class ENV_BESS(gymnasium.Env):
    ...
    def __init__(self,
        ...
        # ========== OBSERVATION ENHANCEMENT: Loading History (Priority 1.3) ==========
        # Track loading history for temporal context
        # - Stores loading_percent arrays from last 3 timesteps
        # - Enables loading trend computation (is congestion increasing/decreasing?)
        # - Agent learns anticipatory control based on trends
        self.loading_history = []

        # ========== PHASE 1 IMPROVEMENT 4: Initialize SoC Tracking ==========
        # Track SoC before action for feasibility calculation
    ...
    def reset(self, options=None, seed=None, ts=None):
        ...
        # ========== RESET LOADING HISTORY (Priority 1.3) ==========
        # Clear loading history at episode start
        # - First observation will have zero trend
        # - Subsequent observations will compute trend from history
        self.loading_history = []

        # ========== PHASE 1 IMPROVEMENT 4: Reset SoC Tracking ==========
    ...
    def step(self, action):
        ...
        # ========== PHASE 1 IMPROVEMENT 4: Track SoC Before Action ==========
        # Store SoC state BEFORE action is applied
        # This is CRITICAL for action feasibility calculation in reward function
        # Allows reward to compare intended vs actual SoC change
        ...
        self.loading_before_action = max_loading_before  # ← ADD THIS LINE
        ...
        self.loading_after_action = max_loading_after  # ← ADD THIS LINE
        ...
        # ========== UPDATE LOADING HISTORY (Priority 1.3) ==========
        # Store current loading before moving to next timestep
        # - Used for computing loading trend in next observation
        # - Keeps last 3 timesteps for temporal context
